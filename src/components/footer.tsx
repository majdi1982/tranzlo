          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              {[
                {
                  name: "Facebook",
                  href: "https://www.facebook.com/tranzlo2",
                  svg: (
                ...
                {
                  name: "LinkedIn",
                  href: "https://www.linkedin.com/company/tranzlo",
                  svg: (
                    <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                ...
                {
                  name: "Pinterest",
                  href: "https://pinterest.com/tranzlo",
                  svg: (
                    <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.966 1.406-5.966s-.359-.72-.359-1.781c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.204 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.162 0 7.396 2.965 7.396 6.927 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.354-.629-2.744-1.37l-.749 2.85c-.273 1.039-.997 2.344-1.488 3.14a12.015 12.015 0 003.445.504c6.62 0 11.988-5.37 11.988-12c0-6.629-5.368-12-11.988-12z"/>
                    </svg>
                  ),
                },
              ].map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="h-8 w-8 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary/20 hover:text-primary transition-all"
                >
                  {s.svg}
                </a>
              ))}
