...
import { DollarSign, FileText, ArrowUpRight, ArrowDownRight, Loader2, Download } from "lucide-react";
      ...
      <RoleGuard allowedRoles={["company"]}>
        <div className="space-y-6 max-w-5xl mx-auto">
          <div>
            ...
            <p className="text-muted-foreground">Manage your invoices, payments, and escrow deposits</p>
          </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <Card className="bg-primary/5 border-primary/20">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Total lifetime expenditure</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-2">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Total invoices issued</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-2">
