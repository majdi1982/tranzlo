...
import { Briefcase, CheckCircle, Star, FileText, ArrowRight } from "lucide-react";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              <CardTitle className="text-lg">Latest Open Jobs</CardTitle>
          ...
          <CardContent className="space-y-3">
            {loading ? (
              ...
              <p className="text-sm text-muted-foreground py-4 text-center">No open jobs available right now.</p>
            ) : (
              jobs.map((job) => (
                <div
                  key={job.$id}
