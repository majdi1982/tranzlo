      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden p-12 flex-col justify-between border-r border-white/[0.05]">
        ...
        <div className="max-w-xl">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Access your global translation workspace. Connect with professionals, 
            manage projects, and expand your linguistic reach.
          </p>
        </div>

        <div className="flex gap-12">
          <div>
            <p className="text-3xl font-bold font-outfit">Real-time</p>
            <p className="text-sm text-muted-foreground">Collaboration</p>
          </div>
          <div>
            <p className="text-3xl font-bold font-outfit">Secure</p>
            <p className="text-sm text-muted-foreground">Escrow Payments</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="max-w-md w-full space-y-8 glass-card p-10 border-white/[0.08] shadow-2xl">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold font-outfit">Log in</h2>
            <p className="text-muted-foreground mt-2">Enter your credentials to access Tranzlo.</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#0b0c14] px-2 text-muted-foreground tracking-widest">Or sign in with email</span></div>
          </div>
